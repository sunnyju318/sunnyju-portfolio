...
function About() {
  ...
  return (
    <>
      ...
      <meta property="og:description" content="Learn more about Sunny Ju, a Vancouver-based front-end developer blending code and design for impactful user experiences." />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://jisun-ju.ca/about" />
      <meta property="og:image" content="https://jisun-ju.ca/assets/images/about-og.jpg" />

      {/* Twitter Card */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="About — Sunny Ju" />
      <meta name="twitter:description" content="Learn more about Sunny Ju, a Vancouver-based front-end developer blending code and design for impactful user experiences." />
      <meta name="twitter:image" content="https://jisun-ju.ca/assets/images/about-og.jpg" />
      ...
      <div className='about-wrapper'>
        ...
        <div className='section-image'>
          <img src={koreaImg} id='korea' alt="Scenic view representing Sunny Ju and hometown" loading="lazy" />
        </div>
        ...
        <div className='section-image'>
          <img src={newYorkImg} id='new-york' alt="Sunny Ju in the New York City" loading="lazy" />
        ...
        <div className='section-image'>
          <img src={brisbaneImg} id='brisbane' alt="Market stall in Brisbane, Australia where Sunny launched BirdyJ brand" loading="lazy" />
        </div>
        ...
        <div className='section-image'>
          <img src={sydneyImg} id='sydney' alt="Beachfront in Sydney, Australia during sunny afternoon" loading="lazy" />
        </div>
        ...
        <div className='section-image'>
          <img src={vancouverImg} id='vancouver' alt="Sunny Ju attending the Web Summit event in Vancouver, Canada" loading="lazy" />
        </div>
